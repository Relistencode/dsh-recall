...
export function apply(ctx, config = {}) {
  ...
  // Background warm-up timer (timer service injected above; `ctx.interval`
  // returns a disposer). When the timer is unavailable the semantic vectors
  // still accumulate through the per-call budget in execute().
